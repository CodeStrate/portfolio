...
export const projects: ProjectEntry[] = [
  ...
  },
  {
    ...
    tagline: "Local coding models tested on real engineering work.",
    outcome: "7 backend tasks · Champions track · Agentic V2",
    tags: ["React", "TypeScript", "LLM Evaluation", "Agentic RAG"],
    visual: "arena",
    stack: "React, TypeScript, Vite, Tailwind CSS, local LLMs",
    date: "2026",
    description: [
      "An execution-first benchmark for open-source coding models run locally on a 24 GB MacBook. The original track scores seven backend tasks, from async refactoring and race conditions to distributed job scheduling. The Champions track adds an async circuit-breaker pool and a dependency-injection container.",
      "Agentic V2 tests models building and extending a LangChain, Ollama, and Chroma RAG application. The site has track-specific leaderboards and a read-only viewer for recorded sessions, including tool calls, file edits, and failures.",
    ],
    links: [
